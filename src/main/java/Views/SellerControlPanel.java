...
public class SellerControlPanel extends javax.swing.JPanel {
    ...
    private void readSellers(){
        ...
        try {
            ...
            if(resultado.length() > 0) {
                ...
                sellers = new Gson().fromJson(resultado, listType);
            }
            
            DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
            model.setRowCount(0);
            for(User seller : sellers){
                if(seller.getUser_type() != 3){
                    continue;
                }
                ...
                for(Sucursal s : sucursales){
                    if(s.getIdSucursal() == seller.getSucursal()){
                ...
                model.addRow(new Object[]{seller.getId_user(), seller.getUsername(), seller.getPhone(), seller.getEmail(), sucursal, estado});
    ...
    private void btnDeleteClientActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteClientActionPerformed
        ...
        sellers.remove(sellers.indexOf(seller));
        save(sellers, USER_FILE);
    ...
    private void btnChangeSucursalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChangeSucursalActionPerformed
        ...
        sellers.set(sellers.indexOf(seller), seller);
    ...
    private void btnChangeStatusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChangeStatusActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Estado cambiado del vendedor: "+seller.getUsername());
    ...
    private void save(ArrayList<User> lista, String path){
