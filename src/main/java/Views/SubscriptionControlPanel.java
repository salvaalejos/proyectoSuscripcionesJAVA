...
public class SubscriptionControlPanel extends javax.swing.JPanel {
    ...
    private void readSubscriptions(){
        ...
        try {
            BufferedReader br = new BufferedReader(
                new FileReader(SUBSCRIPTION_PLAN_FILE)
            );
            String lectura;
            String resultado = "";
    ...
    private void btnAddSucursal1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddSucursal1ActionPerformed
        ...
        Integer idSuscription = subscriptions.size() + 1;
        ...
        SubscriptionPlan subscription = new SubscriptionPlan(idSuscription, price, title, description, idSucursal, true);
